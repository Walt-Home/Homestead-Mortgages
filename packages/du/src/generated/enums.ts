...
export const DU_ENUMERATIONS: Readonly<Record<string, readonly string[]>> = {
  ...
  DuMortgageType: ["Conventional", "FHA", "USDARuralDevelopment", "VA"],
  DuPropertyEstateType: ["FeeSimple", "Leasehold"],
  DuAttachmentType: ["Attached", "Detached"],
  DuAmortizationType: ["AdjustableRate", "Fixed", "GEM", "GPM", "Other"],
