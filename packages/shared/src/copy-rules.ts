 ...
 *   Copy that says we will email, write or call is a promise no code can keep,
 *   and on a page a person can revisit for weeks it is one they will notice us
 *   breaking. "We'll put it here" is fine: the page is the delivery.
...
export const PROMISES =
  /\b(we'?ll (e-?mail|write|call|post|send)|we will e-?mail|by e-?mail|to your (e-?mail|inbox)|in the (post|mail)|letter (is )?(on its way|in the (post|mail))|get in touch|be in touch|reach out|contact you|give you a call|we'?ll tell you|we can tell you|tell you when|let you know|talk to (someone|us))\b/i;
 ...
 */
export const BRITISH = /\b(payslip|cancelled|colour|behaviour|authoris\w*|instalment|whilst)\b/i;
