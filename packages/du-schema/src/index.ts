 ...
 * Schema validity is a lint. The gate is our own preflight and our database.
 */
 ...
 * `xmllint` ships with macOS and with every Linux image this repo builds on, so
 * shelling out costs nothing and adds nothing to what everybody installs.
 *
