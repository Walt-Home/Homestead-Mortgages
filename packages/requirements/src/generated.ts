...
export const REQUIREMENTS: readonly Requirement[] = [
  ...
  },
  {
    ...
    "screenOrdinal": 4,
    "source": "borrower_input",
    "statement": "Section 5a declarations answered by the borrower",
    "fields": "intent_to_occupy, homeowner_past_three_years, undisclosed_borrowed_funds and amount, undisclosed_mortgage_application, undisclosed_credit_application, property_proposed_clean_energy_lien",
    "evidence": [
      "URLA Section 5a"
    ],
    "condition": "universal",
  ...
  },
  {
    ...
    "screenOrdinal": 4,
    "source": "borrower_input",
    "statement": "Section 5b financial declarations answered by the borrower",
    "fields": "undisclosed_comaker_of_note, outstanding_judgments, presently_delinquent, prior_property_deed_in_lieu_conveyed, prior_property_short_sale_completed, prior_property_foreclosure_completed, bankruptcy",
    "evidence": [
      "URLA Section 5b"
    ],
    "condition": "universal",
  ...
  },
  {
    ...
    "screenOrdinal": 4,
    "source": "borrower_input",
    "statement": "Bankruptcy chapters identified",
    "fields": "bankruptcy_chapters: one or more of Chapter 7; 11; 12; 13",
    "evidence": [
      "URLA Section 5b",
      "discharge or dismissal papers"
    ],
    "condition": "declared_bankruptcy",
    "conditionProse": "Borrower declared a bankruptcy",
    "dayOneCertainty": null,
    "failureSeverity": "repurchase_unsaleable",
    "timing": {
      "kind": "at",
  ...
  },
  {
    ...
    "screenOrdinal": 4,
    "source": "borrower_input",
    "statement": "Prior property usage declared",
    "fields": "prior_property_usage; prior_property_title where the borrower states it",
    "evidence": [
      "URLA Section 5a"
    ],
    "condition": "declared_homeowner_past_three_years",
    "conditionProse": "Borrower owned a home in the past 3 years",
    "dayOneCertainty": null,
    "failureSeverity": "rework_delay",
    "timing": {
      "kind": "at",
  ...
  },
  {
    ...
    "screenOrdinal": 4,
    "source": "borrower_input",
    "statement": "Current residence stated",
    "fields": "residency_basis, duration_months, monthly_rent when the basis is rent",
    "evidence": [
      "URLA Section 1a"
    ],
    "condition": "universal",
  ...
  },
  {
    ...
    "screenOrdinal": 4,
    "source": "borrower_input",
    "statement": "Prior residence stated",
    "fields": "prior address, city, state, postal_code, residency_basis, duration_months",
    "evidence": [
      "URLA Section 1a"
    ],
    "condition": "current_residence_under_two_years",
    "conditionProse": "Current residence under 24 months",
    "dayOneCertainty": null,
    "failureSeverity": "rework_delay",
    "timing": {
      "kind": "at",
