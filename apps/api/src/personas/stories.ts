 ...
 * these do not.
 */
export interface SeededPersona extends PersonaBase {
...
export interface DeferredPersona extends PersonaBase {
...
export const PERSONA_STORIES: readonly PersonaStory[] = [
  ...
  },
  {
    ...
    story: "Two people, commission income and a gift. Approved, with the conditions named on it.",
  ...
  },
  {
    ...
    story:
      "Thin credit at a high price: declined on the pricing tests, the one decline this engine can make.",
  ...
  },
  {
    ...
    story: "Held on a match against a screening list. Only a sample can show this one.",
    target: "suspended",
    fixture: "clean_w2",
