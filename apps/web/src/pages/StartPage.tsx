  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-20">
      ...
      <p className="mt-10 text-[13px] leading-relaxed text-subtle">
        This is a prototype. Connections return fixture data, and the decision comes from our own
        engine rather than an agency underwriting system — nothing here is a loan commitment.
      </p>
    </div>
  );
}
